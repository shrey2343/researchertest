...
import { ArrowLeft, Shield, Lock, Eye, CheckCircle, AlertCircle, Beaker, Brain, Database, Dna, FlaskConical, Atom, Rocket, Target, Award, GraduationCap, Globe, Microscope, Code, Lightbulb, BookOpen, Briefcase, TrendingUp, Sparkles, Zap, Star, Heart, Search, FileText } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        >
          <div className="flex items-center gap-4 mb-6">
            ...
            <h1 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent">Privacy Policy</h1>
          </div>
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <div className="space-y-4">
              {[
                { text: 'We collect only necessary information to provide our services.', icon: Database },
                { text: 'Your personal identity is anonymized and not shared publicly.', icon: Eye },
                { text: 'We do not sell or rent user data to third parties.', icon: Shield },
                { text: 'Data is securely stored and protected using industry standards.', icon: Lock },
                { text: 'You may request data deletion by contacting support.', icon: AlertCircle },
                { text: 'By using our platform, you consent to this privacy policy.', icon: CheckCircle }
              ].map((item, index) => {
                const IconComponent = item.icon;
                return (
                  <motion.div
                    ...
                    className="flex gap-4 items-start p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border border-green-200 hover:shadow-md transition-all"
                  >
                    <IconComponent className="text-green-600 flex-shrink-0 mt-0.5" size={24} />
            ...
            <motion.div
              ...
              className="mt-12 p-6 bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl border-2 border-green-200 shadow-lg"
            >
