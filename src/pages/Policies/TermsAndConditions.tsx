...
import { ArrowLeft, Shield, FileText, CheckCircle, AlertCircle, Beaker, Brain, Database, Dna, FlaskConical, Atom, Rocket, Target, Award, GraduationCap, Globe, Microscope, Code, Lightbulb, BookOpen, Briefcase, TrendingUp, Sparkles, Zap, Star, Heart, Eye, Search } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        >
          <div className="flex items-center gap-4 mb-6">
            ...
            <h1 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent">Terms & Conditions</h1>
          </div>
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <div className="space-y-4">
              {[
                ...
                'The platform is intended for academic and professional assistance only.',
                'Any misuse, fraudulent activity, or violation of policies may result in account suspension.',
                ...
                <motion.div
                  ...
                  className="flex gap-4 items-start p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-200 hover:shadow-md transition-all"
                >
                  <CheckCircle className="text-blue-600 flex-shrink-0 mt-0.5" size={24} />
            ...
            <motion.div
              ...
              className="mt-12 p-6 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl border-2 border-blue-200 shadow-lg"
            >
