...
import { ArrowLeft, Box, Star, CheckCircle } from 'lucide-react';
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-12">
          ...
          <div className="flex flex-col lg:flex-row items-start gap-8">
            <div className="flex-1">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-2">Supply Chain</h1>
                  <div className="flex items-center gap-4">
                    ...
                    <span className="text-gray-600">950+ projects completed</span>
                  </div>
                </div>
              </div>
              <p className="text-xl text-gray-600 leading-relaxed mb-6">
                Logistics & optimization solutions to streamline your supply chain operations.
              </p>
              <p className="text-gray-700 leading-relaxed">
                Our supply chain experts help optimize your logistics operations, reduce costs, and improve efficiency. From inventory management to distribution strategy, we provide comprehensive supply chain solutions.
              </p>
            </div>
            <div className="bg-gradient-to-r from-blue-500 to-indigo-500 text-white p-6 rounded-2xl text-center min-w-[200px]">
              ...
              <div className="text-3xl font-bold mb-4">$45/hr</div>
          ...
          {[
            {
              ...
              description: 'Route optimization and transportation management',
              price: '$45-70/hr',
              features: ['Route Planning', 'Transportation Management', 'Cost Optimization']
            },
            {
              title: 'Inventory Management',
              description: 'Inventory control and warehouse optimization',
              price: '$40-65/hr',
              features: ['Inventory Control', 'Warehouse Design', 'Stock Optimization']
            },
            {
              title: 'Procurement Strategy',
              description: 'Supplier management and procurement optimization',
              price: '$50-80/hr',
              features: ['Supplier Selection', 'Contract Negotiation', 'Risk Management']
            },
            {
              title: 'Supply Chain Analytics',
              description: 'Data-driven insights for supply chain performance',
              price: '$55-85/hr',
              features: ['Performance Analytics', 'Demand Forecasting', 'KPI Tracking']
            }
          ].map((category, index) => (
        ...
        <div className="bg-gradient-to-r from-blue-500 to-indigo-500 text-white rounded-3xl p-8 sm:p-12 text-center">
          ...
          <p className="text-xl opacity-90 mb-8 max-w-2xl mx-auto">
            Connect with supply chain experts and streamline your operations for maximum efficiency.
          </p>
