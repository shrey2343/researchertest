...
import { ArrowLeft, Code, Star, CheckCircle, Users, Clock } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-12">
          ...
          <div className="flex flex-col lg:flex-row items-start gap-8">
            <div className="flex-1">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-2">AI Development</h1>
                  <div className="flex items-center gap-4">
                    ...
                    <span className="text-gray-600">1,200+ projects completed</span>
                  </div>
                </div>
              </div>
              <p className="text-xl text-gray-600 leading-relaxed mb-6">
                Machine learning & AI solutions for intelligent automation and data insights.
              </p>
              <p className="text-gray-700 leading-relaxed">
                Transform your business with cutting-edge AI technology. Our experts specialize in machine learning, deep learning, natural language processing, and computer vision to create intelligent solutions that drive innovation and efficiency.
              </p>
            </div>
            <div className="bg-gradient-to-r from-blue-500 to-indigo-500 text-white p-6 rounded-2xl text-center min-w-[200px]">
              ...
              <div className="text-3xl font-bold mb-4">$75/hr</div>
          ...
          {[
            {
              ...
              description: 'Custom ML models and algorithms for predictive analytics',
              price: '$75-120/hr',
              features: ['Model Development', 'Data Preprocessing', 'Algorithm Optimization']
            },
            {
              title: 'Deep Learning',
              description: 'Neural networks and deep learning solutions',
              price: '$90-150/hr',
              features: ['CNN/RNN Development', 'Transfer Learning', 'Model Training']
            },
            {
              title: 'Natural Language Processing',
              description: 'Text analysis, chatbots, and language understanding',
              price: '$80-130/hr',
              features: ['Text Classification', 'Sentiment Analysis', 'Chatbot Development']
            },
            {
        ...
        <div className="bg-gradient-to-r from-blue-500 to-indigo-500 text-white rounded-3xl p-8 sm:p-12 text-center">
          <h3 className="text-3xl font-bold mb-4">Ready to Build Your AI Solution?</h3>
          <p className="text-xl opacity-90 mb-8 max-w-2xl mx-auto">
            Connect with expert AI developers and transform your business with intelligent solutions.
          </p>
